...
const DestinationPage = async ({ searchParams, tourParams }: HotelPageProps) => {
  ...
  return (
    ...
    <div className="all-destinations-main flex flex-col items-center justify-center text-lg font-bold">
        <h1 className="color-h1-destinations-main">American Prime <span className="color-span-green">Destinations</span></h1>
      ...
      <Container>
        ...
        <h1 className="main-header-black w-full text-center">AMERICAN PRIME <span className="main-header-gradient py-1">DESTINATIONS</span></h1>
      ...
      <div className="pt-0 grid grid-cols-3 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-5 gap-8">
        ...
        <div className="w-full text-center pt-8">
          <Link className="outline-main-btn px-4 hover:bg-slate-400 hover:text-green-400 hover:shadow-md" href="/allamericandestinations">View prime destinations</Link>
        </div>
          </Container>
