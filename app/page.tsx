    ...
    <div className="w-full carousel-main-div-carousel">
      ...
      {filteredTours && filteredTours.length > 0 && (
        <Container>
          ...
          <div className="grid-cols-page-s pt-9 pb-4 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-4 gap-8">
      ...
      <div className="tour-inconfort flex flex-col py-12 my-9 items-center justify-center text-lg font-bold">
        <h1 className="color-h1-white pb-4">Tour in comfort and style</h1>
          ...
          <Container>
            <div className="booking-card grid w-full px-5 gap-32 grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-4 sm:my-3 sm:py-2 md:py-4 lg:py-5 xl:py-7 2xl:py-7 my-9">
            <CardDisplay
              icon={FaStar}
      ...
      <Container>
        ...
        <div className="trending-list-main-page pt-4 pl-16 pb-4 justify-between grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-5 gap-6">
