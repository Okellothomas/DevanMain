  ...
  return (
    ...
    <div className="all-destinations-main flex flex-col items-center justify-center text-lg font-bold">
      ...
      <Container>
        ...
        <h1 className="main-header-black w-full text-center">PRIME AUSTRALIAN <span className="main-header-gradient py-1">DESTINATIONS</span></h1>
      ...
      <div className="pt-0 grid grid-cols-3 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-5 gap-8">
        ...
        <div className="w-full text-center pt-8">
          <Link className="outline-main-btn px-4 hover:bg-slate-400 hover:text-green-400 hover:shadow-md" href="/allaustraliandestinations">View prime destinations</Link>
        </div>
          </Container>
