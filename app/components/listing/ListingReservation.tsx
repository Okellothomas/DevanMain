        ...
        <div className="bg-white rounded-xl border-[1px] border-neutral-200 overflow-hidden">
            ...
            <div className="flex flex-col px-4 justify-between item-center gap-1">
                ...
                <div className="flex flex-row items-center mt-2">
                    ...
                    />
                    {openoptions && (
                        <div className="absolute payment-options-rooms-reservation bottom-0 left-0 bg-white p-5 md:p-7 shadow-md" ref={numberOfGuestsRef}>
                            <div className="flex flex-col gap-3">
                                <div className="flex flex-col gap-3">
                                    <span className="text-lg">Rooms</span>
                                    <div className="flex gap-3 items-center">
                ...
                {showPaymentButton ? (
                    ...
                    <div className="text-gray-600 text-center">
                        Please specify the number of guests to book.
                    </div>
                )}
            </div>
            <hr />
