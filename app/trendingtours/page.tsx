...
// // Define the DestinationPage component
// const DestinationPage = ({ tourParams }: DestinationPageProps) => {
//   const [currentUser, setCurrentUser] = useState<any>(null);
//   const [tours, setTours] = useState<any[]>([]);
//   const [tourss, setTourss] = useState<any[]>([]);

//   // Fetch current user and trending tours when the component mounts
//   useEffect(() => {
...
//         const trendingTours = await getTrendingTours({
//           ...tourParams,
//           deal: "trending"
//         });
//         setTours(trendingTours);

//         const allTours = await getTours(tourParams);
//         setTourss(allTours);
//       } catch (error) {
...
//   // Check if there are no tours, display EmptyStates component
//   if (tours.length === 0) {
